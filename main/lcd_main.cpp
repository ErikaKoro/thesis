...
#include "../components/arduino/cores/esp32/lvgl_tft/st7789.h"

#include "../components/arduino/cores/esp32/lvgl_tft/disp_spi.h"
...
static void st7789_send_data(void * data, uint16_t length)
{
    ...
    disp_spi_send_data(_data, length);
}
...
static void st7789_send_color(void * data, uint16_t length)
{
    ...
    disp_wait_for_pending_transactions();
    gpio_set_level(ST7789_DC, 1);
    disp_spi_send_colors(_data, length);
}
